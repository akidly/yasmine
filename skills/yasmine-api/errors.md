...
| `invalid_pagination_param` | 400 | Paramètre de pagination hors borne. Les cas `limit ≤ 0` / `limit > 200` tombent aujourd'hui sur `validation_error` (422) via Pydantic ; ce slug est réservé pour des dépassements futurs spécifiques au handler. |
